...
for isub = 1:length(SUBJ)
  ...
  data{end+1} = ft_preprocessing(cfg); % Now you should have a structure "data" in your workspace
  ...
  switch trial_method % this switches between the two trial methods
    case 'trigger' % these lines are run if trial_method is set to 'trigger';
      ...
      data = ft_redefinetrial(cfg, data{end}); % this gives you trials for each time the spacebar was pressed
  ...
  %% your preprocessed data to file
